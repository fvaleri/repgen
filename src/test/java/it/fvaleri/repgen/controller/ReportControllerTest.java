...
public class ReportControllerTest {
    ...
    public void pdfRequest() throws Exception {
        ...
        String content = CommonHelper.fileToString("simple-letter.json");
    ...
    public void xlsRequest() throws Exception {
        MediaType contentType = new MediaType(MediaType.APPLICATION_JSON.getType(),
            MediaType.APPLICATION_JSON.getSubtype(), Charset.forName("utf8"));
        String content = CommonHelper.fileToString("simple-table.json");
    ...
    public void searchReport() throws Exception {
        MediaType contentType = new MediaType(MediaType.APPLICATION_JSON.getType(),
            MediaType.APPLICATION_JSON.getSubtype(), Charset.forName("utf8"));
        String content = CommonHelper.fileToString("report-search.json");
